...
module Quipper.Utils.Auxiliary (
  -- * List operations
  applyAt,
  overwriteAt,
  has_duplicates,
...
-- | A right-to-left version of 'Control.Monad.zipWithM', which is
...
-- 'reflexivity', 'symmetry', and 'transitivity' are the only exposed
...
-- 'Quipper.Internal.QData.qcdata_zip' or
-- 'Quipper.Internal.QData.qcdata_promote', throws an error because of
